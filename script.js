const products = [
  {id:1,name:"Essential Oversized Tee",cat:"T-Shirts",price:899,tag:"Trending",color:"",desc:"A relaxed everyday silhouette in soft premium cotton.",img:""},
  {id:2,name:"Classic Oxford Shirt",cat:"Shirts",price:1499,tag:"New",desc:"A clean, versatile shirt made for smart-casual days.",img:"alt"},
  {id:3,name:"Relaxed Cargo Pant",cat:"Bottoms",price:1799,tag:"Trending",desc:"Utility-inspired cargo pants with a relaxed fit.",img:"beige"},
